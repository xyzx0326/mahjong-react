...
export class GameUtils {
    ...
    static isFive(board: number[], current: number) {
        const rowIndex = Math.floor(current / 15);
        const colIndex = current % 15;
        ...
        const direction = [
            {
                flag: true,
                condition: (i: number) => colIndex + i < 15,
            ...
            {
                flag: true,
                condition: (i: number) => rowIndex + i < 15,
                boardIndex: (i: number) => current + i * 15
            },
            {
                flag: true,
            ...
            {
                flag: true,
                condition: (i: number) => colIndex + i < 15 && rowIndex + i < 15,
                boardIndex: (i: number) => current + i * 16
            },
            {
                flag: true,
            ...
            {
                flag: true,
                condition: (i: number) => colIndex - i >= 0 && rowIndex + i < 15,
                boardIndex: (i: number) => current + i * 14
            },
            {
                flag: true,
                condition: (i: number) => colIndex + i < 15 && rowIndex - i >= 0,
                boardIndex: (i: number) => current - i * 14
            },
        ]
        // 横, 竖, 横+竖+, 横+竖-
