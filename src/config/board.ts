...
const cardWidth = endWidth * cardScale;
const cardHeight = endWidth * cardScale / cardSourceWidth * cardSourceHeight;

const boardEdge = (direction === 1 ? (endWidth - 14 * cardWidth) : (endHeight - 7 * cardWidth)) / 2
